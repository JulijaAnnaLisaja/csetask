...
public class AndResult implements Result {
     ...
     */
    public AndResult(Result ingredient1, Result ingredient2, Result ingredient3) {
     ...
     * @return first AND second AND third result interpreters.
     */
    @Override
